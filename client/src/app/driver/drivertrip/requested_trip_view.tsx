...
const RequestedTripView = ({ accountData, setAccountData }: RiderFlowRequestedTripProps) => {
            ...
            <div className="flex mobile:flex-col space-y-4 lg:space-y-0 lg:flex-row w-full h-full lg:space-x-4">
                <div className="flex flex-col min-h-[20rem] h-auto overflow-y-auto lg:h-full w-full lg:w-8/12 bg-gray-200 dark:bg-neutral-900 rounded-xl p-6">
...

                    {
                        !trip?.assigned_driver && (
                            <div className="flex flex-col space-y-2 mt-2">
                                <h1 className="text-black dark:text-white font-RobotoSemiBold text-lg">No driver assigned. You will see fare details here once the riders accepts your request.</h1>
                            </div>
                        )
                    }
...

                    {
                        confirmRemoveTrip ? (
                            ...
                            className="w-48"
                            onPress={() => {
                                fetch(`${fetchBase}/v1/trip/${trip_uuid}/driver/freeform/remove`, {
                                    method: "POST",
                                    credentials: "include",
                                    headers: {
                                        "Content-Type": "application/json",
...
export default RequestedTripView;