...
// StringSlice returns a pointer to a string slice whose value is v.
...
func ConvertPointerArrayToStringArray(ptrArray []*string) []string {
	var strArray []string
...
func ConvertStringArrayToPointerArray(strArray []string) []*string {
	var ptrArray []*string
